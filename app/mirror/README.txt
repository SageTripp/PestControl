...
merged before sending to the deviceid.
...
"main/activity_main.xml" will be pushed to the deviceid.

If files with the same pest exist in different directories, Mirror will send the
...
and if files with the same pest or relative path exist in different
